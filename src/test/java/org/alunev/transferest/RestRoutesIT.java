...
public class RestRoutesIT {
    ...
    @ClassRule
    public final static SparkServer<TestSparkApplication> testServer = new SparkServer<>(TestSparkApplication.class, 5678);
    ...
    public void setUp() throws Exception {
        ...
        accountService = new AccountService(new TestSql2oFactory(), userService);
    }
    ...
    public void putUserGives200() throws Exception {
        ...
        HttpResponse response = testServer.execute(
                testServer.put("/v1/users/0",
    ...
    public void deleteUserGives200() throws Exception {
        ...
        HttpResponse response = testServer.execute(
                testServer.delete("/v1/users/0", false)
        );
    ...
    public void accountMethodsGive200() throws Exception {
        ...
        assertThat(post("/v1/users/0", toJson(account)).code()).isEqualTo(200);
        assertThat(put("/v1/users/0", toJson(account.toBuilder().number("555").build())).code()).isEqualTo(200);
        assertThat(get("/v1/users/0").code()).isEqualTo(200);
